...
// see the BeadClaimReleased constant for the release shapes, and for why this
// event following an execution.step_started on the same subject is a
// compensation pair that a consumer must NOT read as a step still in flight.
