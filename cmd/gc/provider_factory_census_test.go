...
var canonicalProviderCalls = map[string]int{
	...
	"cmd_handoff.go:cmdHandoffWithSender:newSessionProvider:bind-error":                                                                        1,
	"cmd_handoff.go:cmdHandoffRemoteWithSender:newSessionProvider:bind-error":                                                                  1,
	...
	"cmd_session.go:cmdSessionKey:newSessionProvider:bind-error":                                                                               1,
